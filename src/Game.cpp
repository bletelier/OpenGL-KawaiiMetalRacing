...
void Game::init()
{
	...
	this->vehicle1 = new Vehicle((char*)"mallas/ae86-t.obj",shader_programme,btScalar(25),
		mapa -> getP1StartPosition(),btQuaternion(0,1,0,0),dynamicsWorld,(char*)"textures/ae86_t2.png");
...
=======
	this->piso2= new GameObject((char*)"mallas/kawaii_background.obj",shader_programme,btScalar(0),
...
>>>>>>> 9042497ac488d0c91cdc392870f99975698e6c7c
